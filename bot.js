...
const memes = new Map([
  ...
  [
    "crab rave",
    { fileNames: ["crab_rave_sound_effect_84840729185338176.mp3"] },
  ],
  [
    "croissant",
    { fileNames: ["carl_wheezer_croissant_2900525901889400232.mp3"] },
  ],
  [
    "dinkster",
    { fileNames: ["somebody_ring_the_dinkster_-2919279323241905165.mp3"] },
  ],
  ...
  [
    "im taking a shit",
    { fileNames: ["please_get_out_im_taking_a_shit_-606515860420089524.mp3"] },
  ],
  ...
  [
    "pro cycling manager",
    { fileNames: ["pro cycling manager.mp3"], volume: 0.4 },
  ],
